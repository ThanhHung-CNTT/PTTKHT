...
namespace Tiểu_Luận
{
    public partial class frmchedo : Form
    {
            ...
            try
            {
                ...
                if (!cls.kttrungkhoa(txt1.Text, "select MaSoBH from TblSoBH"))
                {
                    if (txt1.Text != "")
                    {
                        ...
                        dtgv2.Refresh();
                        cls.loaddatagridview1(dtgv2, ds1, "select * from TblSoBH");
        ...
        private void dtgv2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txt1.Text = dtgv2.Rows[i].Cells[1].Value.ToString();
            txt2.Text = dtgv2.Rows[i].Cells[2].Value.ToString();
            dt1.Text = dtgv2.Rows[i].Cells[3].Value.ToString();
            txt3.Text = dtgv2.Rows[i].Cells[4].Value.ToString();
            txt4.Text = dtgv2.Rows[i].Cells[5].Value.ToString();
        }
        ...
        {
            int i = e.RowIndex;
            txt5.Text = dtgv.Rows[i].Cells[0].Value.ToString();
            txt6.Text = dtgv.Rows[i].Cells[1].Value.ToString();
            comboBox2.Text = dtgv.Rows[i].Cells[2].Value.ToString();
            txt7.Text = dtgv.Rows[i].Cells[3].Value.ToString();
            dt2.Text = dtgv.Rows[i].Cells[4].Value.ToString();
            dt3.Text = dtgv.Rows[i].Cells[5].Value.ToString();
            dt4.Text = dtgv.Rows[i].Cells[6].Value.ToString();
            dt5.Text = dtgv.Rows[i].Cells[7].Value.ToString();
        ...
        private void btS_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cls.thucthiketnoi(update);
                cls.loaddatagridview1(dtgv, ds2, "select * from TblThaiSan");
